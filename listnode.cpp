...
// 注释掉显式实例化，让编译器自动处理
// template class MySTL::ListNode<int>;
// template class MySTL::ListNode<double>;
// template class MySTL::ListNode<char>;
// template class MySTL::ListNode<std::string>;

// template class MySTL::List<int>;
// template class MySTL::List<double>;
// template class MySTL::List<char>;
// template class MySTL::List<std::string>;
